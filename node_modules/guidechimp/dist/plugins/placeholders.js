...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["guideChimpPluginPlaceholders"] = factory();
	else
		root["guideChimpPluginPlaceholders"] = factory();
})(window, function() {
...
module.exports = function (cls, factory) {
  ...
  var _options$template = options.template,
      template = _options$template === void 0 ? '{*}' : _options$template; // eslint-disable-next-line no-param-reassign

  cls.placeholders = {}; // eslint-disable-next-line no-param-reassign
  ...
  cls.prototype.removePlaceholders = function () {
    var _this = this;
  ...
  cls.prototype.init = function () {
    ...
    this.on('onBeforeChange', /*#__PURE__*/function () {
      var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(toStep) {
        var _len,
            args,
            _key,
            placeholders,
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                placeholders = toStep.placeholders;
                ...
                return Promise.resolve().then(function () {
                  ...
                  return (_placeholders = placeholders).call.apply(_placeholders, [_this2, toStep].concat(args));
                });
              ...
              case 6:
                placeholders = _objectSpread(_objectSpread({}, _this2.placeholders), placeholders);
                placeholdersKeys = Object.keys(placeholders);

                if (placeholdersKeys.length) {
                  replacePlaceholders = function replacePlaceholders(object) {
                    placeholdersKeys.forEach(function (placeholderKey) {
                      var search = template.replace('*', placeholderKey);
                      Object.keys(object).forEach(function (key) {
                        var value = toStep[key];
