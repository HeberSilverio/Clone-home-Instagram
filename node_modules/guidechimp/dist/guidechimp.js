...
var GuideChimp = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(GuideChimp, [{
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 43:
                ...
                setTimeout(function () {
                  _this2.scrollTo(tooltipLayer, 'smooth');
                }, 300);
    ...
    value: function getScrollableParentElement(el) {
      var axis = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ['x', 'y'];
      ...
      var getScrollableParent = function getScrollableParent(parent) {
        ...
        var overflow = '';
        var overflowAxis = Array.isArray(axis) ? axis : [axis];
        overflowAxis.forEach(function (v) {
          overflow += parentStyle.getPropertyValue("overflow-".concat(v));
        });
        var isScrollable = regex.test(overflow);
    ...
    value: function scrollParentToChildElement(el) {
      var scrollableParentElX = this.getScrollableParentElement(el, 'x');
    ...
    value: function setControlLayerPosition(layer, el) {
      ...
      var _document$documentEle = document.documentElement.getBoundingClientRect(),
          docElWidth = _document$documentEle.width;
